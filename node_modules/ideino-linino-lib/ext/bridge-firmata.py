...
def arg_par():
    ...
    parser.add_argument('-sampling',type=int, help='set the sampling period. (default:%(default)d)',nargs=1, metavar=('[sampling]'),default=[10])
...
if __name__ == "__main__":
    ...
    try:
        thread.start_new_thread( polling, ("Thread-1", sampling/1000))
