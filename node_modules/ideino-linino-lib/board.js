...
Board.prototype.connect = function(callback){
	...
	exec("sh " + this._bridge.stop_exe + " " + this._bridge.bridge, function (error, stdout, stderr) {
		...
		proc  = spawn('python', [that._bridge.bridge_exe, "-log", that._bridge.loglevel, that._bridge.loghandler, "-layout", that._bridge.layout, that._bridge.layoutfile, "-resolution", that._bridge.resolution, "-serial",that._bridge.serial.port, that._bridge.serial.baudrate ]);
