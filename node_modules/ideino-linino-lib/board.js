				...
				switch(args.mode.toLowerCase()) {
					...
					case 'input':
						if(args.pullup){//PULL-UP ENABLED
							pin_register[args.pin].PIN = new Gpio(pin_register[args.pin].NUM, 
					...
					//PWM
					case 'pwm':
						pin_register[args.pin].PIN = new Pwm(pin_register[args.pin].MAP, {bit: pin_register[args.pin].BIT});
						pin_register[args.pin].MOD = args.mode;
						break;
					//SERVO
					case 'servo':
						pin_register[args.pin].PIN = new Servo(pin_register[args.pin].MAP, {bit: pin_register[args.pin].BIT});
						pin_register[args.pin].MOD = args.mode;
						break;
				}
			}
